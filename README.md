...
## Outline??
1. Dataset analysis: Class distribution, image samples, dataset splits
2. Baseline model: simple CNN or pretrained ResNet with no special things. **Serves as baseline, reference point**
